...
bash "$DIR/check-basic.sh" "10 DIM A(3):A(1)=7:PRINT A(1)"     0407=2  || fail=1   # ARR
bash "$DIR/check-basic.sh" "10 A%=5:PRINT A%"                  0407=4  || fail=1   # INT
bash "$DIR/check-basic.sh" "10 VPOKE 0,0,1"                    0407=8  || fail=1   # X16 pass-through
