...
- [GPC runtime size floor](gpc-runtime-size-floor.md) — the 6-tier subset-selected runtime ladder (core/arr/str/arrstr/arrstrdata/full) + how to add a tier; 64tass omits unreferenced .proc; floats already ROM-backed; custom runtimes need an on-device linker
